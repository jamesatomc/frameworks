...
module kanari_framework::test_scenario {
    ...
    /// Utility for mocking a multi-transaction kanari_framework execution in a single Move procedure.
    ...
    public fun return_to_address<T: key>(account: address, t: T) {
        ...
        kanari_framework::transfer::transfer_impl(t, account)
    }
    ...
    public fun return_immutable<T: key>(t: T) {
        ...
        kanari_framework::transfer::freeze_object_impl(t)
    }
    ...
    public fun return_shared<T: key>(t: T) {
        ...
        kanari_framework::transfer::share_object_impl(t)
    }
